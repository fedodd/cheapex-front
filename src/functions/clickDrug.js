...
const clickDrugHandler = (slider) => {
  ...
  let scrollLeft;
  let sl = 0;
  console.log('i am here!, slider.scrollWidth, slider.clientWidth, slider.scrollWidth - slider.clientWidth, slider.scrollLeft', slider.scrollWidth, slider.clientWidth, slider.scrollWidth - slider.clientWidth, slider.scrollLeft);
  ...
  slider.addEventListener('scroll', (e) => {
    ...
    console.log((slider.scrollWidth - slider.clientWidth) <= slider.scrollLeft + 5)
    if ((slider.scrollWidth - slider.clientWidth) <= slider.scrollLeft + 5) {
      slider.classList.remove(classes.is__end);
    } else {
